            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  v-for="saleValue in spuSaleAttr.spuSaleAttrValueList"
                  :key="saleValue.id"
                  @click="
                    changeActive(saleValue, spuSaleAttr.spuSaleAttrValueList)
                  "
                >
...
export default {
  ...
  methods: {
    ...
    changeSkuNum(event) {
      // 首先考虑用户输入到文本框的不合法的只能是三种情况：1.不合法的字符串 2.负数 3.正数小数
      // 获取用户输入到文本框的值
